...
SELECT admissions.subject_id, admissions.diagnosis, admissions.admittime, 
CASE 
    WHEN admissions.subject_id IN
...
and exists (select count(subject_id) from admissions having count(subject_id) < 1) ;